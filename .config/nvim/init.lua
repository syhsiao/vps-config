...
-- Disable termguicolors to support 256-color environments over SSH
vim.opt.termguicolors = false
vim.cmd.colorscheme 'retrobox'

-- 當打開檔案時，自動跳轉到上次關閉時的位置
-- ref. https://stackoverflow.com/questions/79676199/restore-cursor-position-in-neovim-when-opening-multiple-files
